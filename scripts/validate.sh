...
# that same commit. Only the first-parent line is checked: history merged in
# from another lineage carries its own release commits under its own tag namespace.
