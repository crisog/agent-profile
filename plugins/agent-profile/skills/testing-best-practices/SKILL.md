...
- **Proven-pre-existing failures get recorded, not skipped.** Add the failure to the repo's known-flakes note, with its repro command and evidence; future waivers cite the entry instead of re-litigating.
